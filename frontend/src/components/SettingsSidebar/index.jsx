  ...
  return (
    <>
      <div>
        <Link
          to={paths.home()}
          className="flex shrink-0 max-w-[55%] items-center justify-start mx-[20.5px] mt-[10px] mb-[8px]"
        >
          <img
            src={logo}
            alt="Logo"
        ...
        <div
          ref={sidebarRef}
          className="transition-all duration-500 relative mx-[16px] mt-[8px] mb-[16px] rounded-[16px] bg-theme-bg-sidebar border-[2px] border-theme-sidebar-border light:border-none min-w-[250px] p-[10px] h-[calc(100%-60px)]"
        >
