            ...
            <div className="flex w-full justify-between items-center p-6 space-x-2 border-t border-theme-modal-border rounded-b">
              ...
              <div className="flex space-x-2">
                <button
                  onClick={onClose}
                  type="button"
                  className="border-none transition-all duration-300 bg-transparent text-theme-text-primary hover:bg-theme-action-menu-item-hover px-4 py-2 rounded-lg text-sm"
                >
                  Cancel
                </button>
                <button
