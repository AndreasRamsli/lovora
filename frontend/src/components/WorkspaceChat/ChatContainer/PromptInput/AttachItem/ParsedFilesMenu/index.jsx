  ...
  return (
    <div className="flex flex-col gap-2 p-2">
      ...
      {contextWindowLimitExceeded && canEmbed && (
        <div className="flex flex-col gap-2 p-2 bg-theme-bg-secondary rounded">
          ...
          <button
            ...
            className="border-none disabled:opacity-50 flex items-center justify-center gap-2 px-3 py-2 text-xs bg-primary-button text-[var(--theme-button-primary-text)] hover:bg-[var(--theme-button-primary-hover-solid)] font-medium rounded transition-colors shadow-sm"
          >
            {isEmbedding ? (
              <>
