    ...
    <div className="border-b border-white/40 pb-8">
      ...
      <div className="relative">
        ...
        {searchMenuOpen ? (
          ...
          <button
            className="ui-selector-hover w-full max-w-[640px] h-[64px] bg-theme-settings-input-bg rounded-lg flex items-center p-[14px] justify-between cursor-pointer border-2 border-transparent transition-all duration-300"
            type="button"
