    ...
    <div className="w-full mt-6">
      ...
      {hasChanges && (
        <div className="flex justify-start py-6">
          <button
            type="button"
            className="ui-btn-outline transition-all duration-300 border border-slate-200 px-4 py-2 rounded-lg text-sm items-center flex gap-x-2 focus:ring-gray-800"
