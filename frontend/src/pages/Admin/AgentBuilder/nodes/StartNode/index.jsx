  ...
  return (
    <div className="space-y-4">
      <h3 className="text-sm font-medium text-theme-text-primary">
        {t("agent_builder.start.variables")}
      </h3>
      {config.variables.map((variable, index) => (
        <div key={index} className="flex gap-2">
          <input
            type="text"
            placeholder={t("agent_builder.start.variable_name")}
            value={variable.name}
            onChange={(e) => {
          ...
          <input
            type="text"
            placeholder={t("agent_builder.start.initial_value")}
          ...
          {config.variables.length > 1 && (
            <button
              ...
              title={t("agent_builder.start.delete_variable")}
            >
              <X className="w-4 h-4" />
            </button>
          )}
          {index === config.variables.length - 1 && (
            <button
              ...
              title={t("agent_builder.start.add_variable")}
            >
