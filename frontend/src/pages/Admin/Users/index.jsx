      ...
      >
        <div className="flex flex-col w-full px-1 md:pl-6 md:pr-[50px] md:py-6 py-16">
          ...
          <div className="w-full justify-end flex">
            ...
            >
              <UserPlus className="h-4 w-4" weight="bold" /> {t("users.add")}
            </CTAButton>
          </div>
...
const ROLE_HINT = {
  default: ["users.roles.default.0", "users.roles.default.1"],
  manager: [
    "users.roles.manager.0",
    "users.roles.manager.1",
    "users.roles.manager.2",
  ],
  admin: ["users.roles.admin.0", "users.roles.admin.1"],
};
  ...
  return (
    <div className="mt-4 mb-8">
      <Toggle
        size="md"
        variant="horizontal"
        label={t("users.message_limit.label")}
        description={t("users.message_limit.description")}
        enabled={enabled}
        onChange={(checked) => {
          updateState((prev) => ({
            ...prev,
      ...
      {enabled && (
        <div className="mt-4">
          <label className="text-white text-sm font-semibold block mb-4">
            {t("users.message_limit.input_label")}
          </label>
