    ...
    <>
      ...
      <div className="flex w-full justify-between items-center mt-6">
        <button
          ...
          className="ui-btn-outline px-4 py-2 rounded-lg border border-slate-200 light:border-theme-sidebar-border text-sm items-center flex gap-x-2 disabled:invisible"
          disabled={offset === 0}
        >
          {t("common.previous")}
        </button>
