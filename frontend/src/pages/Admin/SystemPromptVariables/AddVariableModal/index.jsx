...
export default function AddVariableModal({ closeModal, onRefresh }) {
  ...
  const handleCreate = async (e) => {
    ...
    try {
      ...
      showToast(t("system_prompt_variables.modal.created"), "success", {
        clear: true,
      });
      ...
      setError(t("system_prompt_variables.modal.create_failed"));
    }
  };
        ...
        <div className="relative p-6 border-b rounded-t border-theme-modal-border">
          <div className="w-full flex gap-x-2 items-center">
            <h3 className="text-xl font-semibold text-white overflow-hidden overflow-ellipsis whitespace-nowrap">
              {t("system_prompt_variables.modal.add_title")}
            </h3>
          </div>
          <button
            onClick={closeModal}
        ...
        <div className="p-6">
          <form onSubmit={handleCreate}>
            ...
            <div className="flex justify-between items-center mt-6 pt-6 border-t border-theme-modal-border">
              ...
              >
                {t("system_prompt_variables.modal.create")}
              </button>
            </div>
          </form>
        </div>
