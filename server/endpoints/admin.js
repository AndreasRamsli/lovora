...
function adminEndpoints(app) {
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/admin/invite/new",
        routeId: "admin.invites.create",
        plane: "control",
        category: "user_management",
        responsePolicy: "metadata_only",
      },
  ...
  app.delete(
    ...
    ...withRoutePolicy(
      {
        method: "DELETE",
        path: "/api/admin/invite/:id",
        routeId: "admin.invites.delete",
        plane: "control",
        category: "user_management",
        responsePolicy: "metadata_only",
      },
  ...
  app.get(
    ...
    ...withRoutePolicy(
      {
        method: "GET",
        path: "/api/admin/workspaces/:workspaceId/users",
        routeId: "admin.workspaces.users",
        plane: "control",
        category: "workspace_admin",
        responsePolicy: "metadata_only",
      },
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/admin/workspaces/new",
        routeId: "admin.workspaces.create",
        plane: "control",
        category: "workspace_admin",
        responsePolicy: "metadata_only",
      },
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/admin/workspaces/:workspaceId/update-users",
        routeId: "admin.workspaces.update-users",
        plane: "control",
        category: "workspace_admin",
        responsePolicy: "metadata_only",
      },
    ...
    ...withRoutePolicy(
      {
        ...
        routeId: "admin.workspaces.delete",
        plane: "control",
        category: "workspace_admin",
        responsePolicy: "metadata_only",
      },
  ...
  app.get(
    ...
    ...withRoutePolicy(
      {
        method: "GET",
        path: "/api/admin/system-preferences-for",
        routeId: "admin.system-preferences.read",
        plane: "control",
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/admin/system-preferences",
        routeId: "admin.system-preferences.update",
        plane: "control",
        category: "system_settings",
        responsePolicy: "metadata_only",
      },
  ...
  app.get(
    "/admin/api-key-workspaces",
    ...withRoutePolicy(
      {
        method: "GET",
        path: "/api/admin/api-key-workspaces",
        routeId: "admin.api-keys.workspaces",
        plane: "control",
        category: "api_keys",
        responsePolicy: "metadata_only",
      },
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/admin/generate-api-key",
        routeId: "admin.api-keys.create",
        plane: "control",
        category: "api_keys",
        responsePolicy: "metadata_only",
      },
  ...
  app.delete(
    ...
    ...withRoutePolicy(
      {
        method: "DELETE",
        path: "/api/admin/delete-api-key/:id",
        routeId: "admin.api-keys.delete",
        plane: "control",
        category: "api_keys",
        responsePolicy: "metadata_only",
      },
