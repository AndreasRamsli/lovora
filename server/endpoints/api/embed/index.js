...
function apiEmbedEndpoints(app) {
  ...
  app.get(
    ...
    ...withRoutePolicy(
      {
        method: "GET",
        path: "/api/v1/embed/:embedUuid/chats",
        routeId: "api.embed.chats.list",
        plane: "control",
        category: "embed",
        responsePolicy: "metadata_only",
        principalAccess: managementMetadataReadAccess,
  ...
  app.get(
    ...
    ...withRoutePolicy(
      {
        method: "GET",
        path: "/api/v1/embed/:embedUuid/chats/:sessionUuid",
        routeId: "api.embed.chats.session",
        plane: "control",
        category: "embed",
        responsePolicy: "metadata_only",
        principalAccess: managementMetadataReadAccess,
  ...
  app.post(
    ...
    ...withRoutePolicy(
      {
        method: "POST",
        path: "/api/v1/embed/:embedUuid",
        routeId: "api.embed.update",
        plane: "control",
        category: "embed",
        responsePolicy: "metadata_only",
        principalAccess: managementMetadataWriteAccess,
      ...
      */
        try {
          ...
          response.status(200).json({
            success,
            error: success ? null : "Failed to delete embed",
          });
        } catch (e) {
          console.error(e.message, e);
          response.sendStatus(500).end();
